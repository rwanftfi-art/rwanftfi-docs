...
<CardGroup cols={2}>
  ...
  <Card title="Registered Trademark (UKIPO)" icon="shield-check" href="/en/intellectual-property">
    The **RWANFT** brand is registered with the UK Intellectual Property Office under the ownership of RWANFTFI Corporation. Publicly verifiable on the official UKIPO registry and legally protected under UK law.
  </Card>
</CardGroup>

Both entities are registered in internationally recognized jurisdictions with well-established legal frameworks for digital asset businesses. Their relationship is governed by comprehensive legal agreements. Market-facing activities are conducted through the appropriate legal entities, while certain product components rely on decentralized technology solutions. The brand itself is protected on a separate, public-registry layer — see [Intellectual Property](/en/intellectual-property) for the full UKIPO record.
...
<CardGroup cols={2}>
  ...
  <Card title="Dispute Resolution" icon="scale-balanced">
    Dispute resolution is handled through the [LCIA (London Court of International Arbitration)](https://www.lcia.org/) — one of the world's leading arbitration institutions. This ensures that any potential disputes are resolved through a globally respected, neutral, and enforceable legal process.
  </Card>
