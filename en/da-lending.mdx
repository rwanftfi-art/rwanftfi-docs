...
<Steps>
  ...
  <Step title="Period 4 - day 365 (+65 days): 100% of the remainder is burned">
    All remaining pledged DA is burned. Loan position fully closed. The borrower keeps the USDT received at issuance and loses the entire collateral.
  </Step>
</Steps>
...
<Info>
  **Worked example - full default on a 100 DA / 70 USDT loan at `loan.price = 1.00`.**
  ...
  The borrower keeps the original 66.50 USDT received at issuance, and loses the entire 100 DA collateral over the 365-day cycle. All burned DA is permanently removed from supply; all USDT routed to the Pool strengthens DA backing for the rest of the ecosystem.
</Info>
