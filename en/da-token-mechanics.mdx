...
<CardGroup cols={2}>
  ...
  <Card title="Burn on Every Sale" icon="fire">
    100% of sold tokens are permanently burned. User receives 75% (manual) or 70% (auto) of value in USDT. The commission (25% or 30%) remains in the liquidity pool, increasing the price for remaining holders.
  </Card>
...
<Info>
  **Founder's Example:** 200 DA in circulation, $200 in the liquidity pool. Price = $1.00 per DA. A user sells 100 DA. The pool pays out $70 (70% of $100 value). All 100 DA are burned. Result: 100 DA remain, $130 in the pool. New price = $130 ÷ 100 = **$1.30 per DA**.
</Info>
...
<CardGroup cols={3}>
  <Card title="Manual Sale" icon="fire">
    100% of sold DA is permanently burned. User receives 75% of value in USDT. Commission: 25% stays in the liquidity pool.
  </Card>
  <Card title="Auto-Sell" icon="clock">
    100% of auto-sold DA is permanently burned. User receives 70% of value in USDT. Commission: 30% stays in the liquidity pool. Triggers progressively from remaining balance over 4 periods (12 months total).
  </Card>
...
If the user does not sell manually, the system triggers automatic sales from the **remaining balance** over 4 periods spanning 12 months total.

**Example starting with 100 DA:**

<Steps>
  <Step title="Period 1 — After 4 months">
    25% of current balance is auto-sold. 25% of 100 = **25 DA sold** → Remaining: **75 DA**
  </Step>
  <Step title="Period 2 — After 3 more months (month 7)">
    40% of remaining balance is auto-sold. 40% of 75 = **30 DA sold** → Remaining: **45 DA**
  </Step>
  <Step title="Period 3 — After 3 more months (month 10)">
    50% of remaining balance is auto-sold. 50% of 45 = **22.5 DA sold** → Remaining: **22.5 DA**
  </Step>
  <Step title="Period 4 — After 2 more months (month 12)">
...
For detailed sell vs. lend comparison, see [Selling & Lending](/en/selling-and-lending).
