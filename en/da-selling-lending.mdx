...
<CardGroup cols={2}>
  <Card title="Sell DA" icon="fire">
    100% of sold DA is permanently burned. You receive 75% (manual) or 70% (auto) of value in USDT. The commission (25% or 30%) stays in the liquidity pool, increasing price for remaining holders.
  </Card>
...
1. **Manual Sale (user sells independently):**
   ...
   * The 25% commission (difference between token value and USDT payout) remains in the liquidity pool, increasing DA price.
...
2. **Auto-Sell (triggered after TokenStack period expires):**
   ...
   * The 30% commission remains in the liquidity pool.
   * Auto-sell triggers automatically if the user has not sold manually before the period expires.

In both cases, 100% of sold tokens are burned — the 25%/30% represents the commission that stays in the pool, not the burn rate. This mathematically increases the price of DA for the remaining holders. Auto-sell offers a 5% lower payout, incentivizing users to actively manage their DA positions.
