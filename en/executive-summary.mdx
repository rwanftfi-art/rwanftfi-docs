...
<CardGroup cols={3}>
  ...
  <Card title="Deflationary Asset" icon="fire">
    21M hard-capped DA token, 100% USDT backed. Funded by 14+ revenue streams — from NFT sales to RWA income. Three burn mechanisms and a biannual Deflationary Cycle ensure price only goes up.
  </Card>
...
<Tip>
  The DA Liquidity Pool is funded by 14 distinct sources across the ecosystem — including 20% of every NFT purchase, marketing commissions, lending fees, expired vouchers, and real-world asset income. Combined with three burn mechanisms (25% manual sale, 30% auto-sell, 100% lending default) and a biannual Deflationary Cycle, the DA economy is engineered for sustained value growth. Explore the full mechanics in the DA Token Mechanics section.
</Tip>
