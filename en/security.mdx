...
description: "RWANFTFI smart contracts are independently audited by CertiK (final report April 28, 2026), layered with three-level account security, single-use TAN codes, separate financial password, and 2FA via the Telegram bot."
icon: "shield-halved"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Download PDF" icon="download" href="https://cdn.jsdelivr.net/gh/rwanftfi-art/rwanftfi-docs@master/CertiK-RWANFTFI-Audit.pdf">
