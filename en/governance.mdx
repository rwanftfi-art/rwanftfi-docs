...
<div style={{
  ...
  <div style={{ flex: 1, fontSize: '16px', lineHeight: '2' }}>
    <div style={{ fontSize: '22px', fontWeight: 700, marginBottom: '8px' }}>GovToken</div>
    <div>ERC20Votes governance token · 6 decimals</div>
    <div>Total supply: <strong>10,000,000</strong></div>
    <div>Auto-delegation on transfer</div>
    <div>Manual delegation disabled</div>
  </div>
</div>
