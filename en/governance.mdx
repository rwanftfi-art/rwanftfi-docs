...
<div style={{
  ...
  <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', marginTop: '16px', lineHeight: '1.8' }}>
    ERC20Votes governance token · <strong style={{ color: 'rgba(255,255,255,0.9)' }}>10,000,000</strong> total supply · 6 decimals<br/>
