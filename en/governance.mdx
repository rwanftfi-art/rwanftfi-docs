...
<div style={{ backgroundColor: '#383838', borderRadius: '16px', padding: '24px', margin: '16px 0 32px 0', display: 'flex', flexWrap: 'wrap', gap: '32px', alignItems: 'center', border: '1px solid rgba(255,255,255,0.05)' }}>
  <div style={{ flexShrink: 0, display: 'flex', justifyContent: 'center', width: '140px' }} className="mx-auto sm:mx-0">
    <video autoPlay muted loop playsInline preload="metadata" style={{ width: '140px', height: '140px', borderRadius: '16px', objectFit: 'cover', display: 'block' }}>
