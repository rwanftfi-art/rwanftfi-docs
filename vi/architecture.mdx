...
2. **Số Dư Tích Lũy (`accumulativeBalance`):** Một tài khoản tiết kiệm bắt buộc nơi 20% của mỗi phần thưởng marketing được ghi có ngay khi tích lũy.
   ...
   * **Phân Phối Lại Sau 120 Ngày:** Nếu người dùng không sử dụng Số Dư Tích Lũy của họ trong vòng 120 ngày, số dư không sử dụng trở nên đủ điều kiện để phân phối lại. Sự phân chia phụ thuộc vào loại NFT của người dùng:
   ...
   <Note>
     **Người nhận chuyển nhượng phải là một nút đang hoạt động.** Một giao dịch chuyển Số Dư Tích Lũy cho người dùng khác chỉ thành công nếu **người nhận đã tồn tại là một nút đang hoạt động** trong hệ thống. Việc tạo tài khoản (email/mật khẩu) không đủ - người nhận phải trước tiên đã tham gia vào hệ thống theo một trong hai cách:

     - Đã thực hiện **bất kỳ lần nạp tiền nào** vào số dư của họ (dù chỉ một lượng tối thiểu), hoặc
     - **Đã kích hoạt một NFT Quà Tặng**, điều này đăng ký họ là một nút trong cấu trúc marketing.

     Nếu người nhận chưa thực hiện cả hai, giao dịch chuyển nhượng không thể hoàn thành: **giao dịch của người gửi bị hoàn nguyên**, và thao tác bị chặn cho đến khi người nhận kích hoạt sự hiện diện on-chain của họ. Điều này phản chiếu quy tắc [**Người tài trợ phải là một nút cây đang hoạt động**](/vi/marketing-binary-tree) - một ánh xạ chỉ định danh (một ví đã được gán ID người dùng nhưng không có trạng thái on-chain đang hoạt động) không thể tham gia, dù là với tư cách người tài trợ hay là người nhận chuyển Số Dư Tích Lũy.
   </Note>
