          ...
          return (
            <button key={nft.level} onClick={() => setSelected(isSel ? null : nft)}
              ...
              <div style={{ width: '100%', overflow: 'hidden', aspectRatio: '1 / 1', backgroundColor: '#1a1a2e' }}>
                <video autoPlay muted loop playsInline src={VIDEO_SRCS[nft.level]} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top', display: 'block', backgroundColor: '#1a1a2e' }} />
              </div>
              {/* Card Info */}
