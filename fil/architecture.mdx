...
2. **Accumulative Balance (`accumulativeBalance`):** Isang sapilitang savings account kung saan ang 20% ng bawat marketing reward ay agad na na-credit pagkatapos ng accrual.
   ...
   * **120-Araw na Redistribution:** Kung hindi ginagamit ng user ang kanilang Accumulative Balance sa loob ng 120 araw, ang hindi nagamit na balance ay nagiging eligible para sa redistribution. Ang split ay depende sa uri ng NFT ng user:
   ...
   <Note>
     **Ang tatanggap ng transfer ay dapat na isang aktibong node.** Ang isang paglilipat ng Accumulative Balance sa ibang user ay matagumpay lamang kung ang **tatanggap ay mayroon nang aktibong node** sa sistema. Ang paglikha ng account (email/password) ay hindi sapat sa sarili nito - ang tatanggap ay dapat munang nakapasok sa sistema sa isa sa dalawang paraan:

     - Nagsagawa ng **anumang deposito** sa kanilang balanse (kahit maliit na halaga), o
     - **Nag-activate ng Gift NFT**, na nagrehistro sa kanila bilang isang node sa marketing structure.

     Kung hindi pa nagawa ng tatanggap ang alinman sa dalawa, hindi makukumpleto ang transfer: ang **transaksyon ng nagpadala ay nire-revert**, at ang operasyon ay nananatiling nakaharang hanggang sa i-activate ng tatanggap ang kanilang presensya on-chain. Ito ay katulad ng panuntunang [**Ang sponsor ay dapat na isang aktibong tree node**](/fil/marketing-binary-tree) - ang isang identity-only mapping (isang wallet na may hawak na user ID ngunit walang aktibong on-chain state) ay hindi maaaring lumahok, maging bilang sponsor o bilang tatanggap ng Accumulative Balance transfer.
   </Note>
